  ...
  <div class="card-header bg-primary text-white border-dark"><strong>Data Admin</strong></div>
    ...
    ?>
        <tr>
	        ...
	        <td align="center">
                <a class="btn btn-warning" href="?page=users&action=update&id=<?php echo $row['id_admin']; ?>">
                    <span class="fas fa-edit"></span>
                </a>
            <a onclick="return confirm('Yakin menghapus data ini ?')" class="btn btn-danger" href="?page=users&action=hapus&id=<?php echo $row['id_admin']; ?>">
